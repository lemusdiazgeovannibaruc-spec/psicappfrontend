...
public class ActivityConversacionPaciente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conversacion_paciente);
        ...
        doctorNombre = getIntent().getStringExtra("doctor_nombre");

        if (pacienteId == -1 || doctorId == -1) {
            Toast.makeText(this, "Error al cargar la conversación", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }

        setTitle("Conversación con " + doctorNombre);
